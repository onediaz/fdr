...
import { createClassrooms } from "../graphql/mutations";
const client = generateClient();
export default function ClassroomsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createClassrooms.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ClassroomsCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
